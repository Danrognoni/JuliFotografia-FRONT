            ...
            >
              @if (siteContentService.content().instagramHandle) {
                <a 
                  ...
                  target="_blank"
                  rel="noopener"
                  class="inline-flex items-center justify-center gap-2 px-5 py-2.5 min-h-[44px] bg-neutral-100 hover:bg-neutral-200 text-neutral-800 text-xs font-semibold rounded-full transition"
                >
