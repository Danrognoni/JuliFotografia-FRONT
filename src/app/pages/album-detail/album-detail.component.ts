...
@Component({
  ...
  template: `
    <div 
      class="min-h-screen text-neutral-900 select-none pb-24 md:pb-36 selection:bg-[#feea68] selection:text-black overflow-x-hidden max-w-full transition-colors duration-500"
      [style.backgroundColor]="album()?.backgroundColor || '#faf6e8'"
    >
